...
import { FiArrowRight, FiBox, FiCode, FiCommand, FiZap } from "react-icons/fi";
...
const PACKAGES: Record<string, Package> = {
	...
	dom: {
		...
		description:
			"Lightweight DOM manipulation utilities for Shopify themes. Typed, tree-shakeable, and ESM only.",
		icon: FiCode,
	...
	ajax: {
		...
		description:
			"A fully typed Shopify AJAX API wrapper. Built on native fetch and async/await.",
		icon: FiBox,
	...
	cli: {
		...
		description:
			"CLI generator for scaffolding Shopify theme section files with Liquid, JS, and CSS.",
		icon: FiCommand,
...
export default async function PackageOverview({
	params,
}: {
		...
		<div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
			...
			<div className="p-8 rounded-3xl bg-gradient-to-br from-brand-purple/10 via-transparent to-brand-teal/10 border border-white/5">
				...
				<p className="text-slate-400 mb-6">
					Explore the detailed API documentation for each feature in the sidebar
					to learn about parameters, return types, and Shopify-specific use
					cases.
				</p>
				<Link
