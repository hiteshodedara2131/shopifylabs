			...
			<div className="flex flex-col lg:flex-row items-center gap-16 max-w-6xl mx-auto">
				...
				<div className="flex-1 text-center lg:text-left">
					...
					<p className="text-slate-400 text-lg mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
						The CLI automatically generates your Liquid schemas, sets up asset
						tags, and wires up a boilerplate JavaScript module with DOM-ready
						checks.
					</p>
					<Link
						href="/docs/cli"
						className="text-brand-blue font-semibold hover:text-brand-teal transition-colors flex items-center gap-2 justify-center lg:justify-start"
					>
