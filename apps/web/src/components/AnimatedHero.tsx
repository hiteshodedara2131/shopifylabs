...
export default function AnimatedHero() {
  ...
  return (
    <section className="container mx-auto px-4 flex flex-col items-center text-center max-w-5xl z-10 pt-16 pb-24">
      ...
      >
        A modern, type-safe, and highly optimized frontend toolkit ecosystem for Shopify theme development by StyloFront. Stop reinventing the wheel.
      </motion.p>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5 bg-[#070B14]/80 backdrop-blur-md">
              ...
              <div className="ml-4 text-xs font-mono text-slate-400">theme.ts</div>
            </div>
