...
describe("getSizedImageUrl", () => {
  it("should append size suffix before extension", () => {
    ...
    expect(getSizedImageUrl(url, "500x")).toBe("//cdn.shopify.com/s/files/1/0000/0000/products/image_500x.jpg");
  });

  it("should handle URLs with query parameters", () => {
    const url = "//cdn.shopify.com/s/files/1/image.png?v=123456";
    expect(getSizedImageUrl(url, "100x100")).toBe("//cdn.shopify.com/s/files/1/image_100x100.png?v=123456");
  });
